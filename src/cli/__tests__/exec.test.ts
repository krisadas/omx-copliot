...
describe('omxc exec', () => {
  it('runs copilot-cli exec with session-scoped instructions that preserve AGENTS and overlay content', async () => {
  ...
  it('passes exec --help through to copilot-cli exec', async () => {
