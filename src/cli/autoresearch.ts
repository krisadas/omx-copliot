...
export const AUTORESEARCH_HELP = `omxc autoresearch - Launch OMX autoresearch with thin-supervisor parity semantics

Usage:
  omxc autoresearch                                                (human entrypoint: launch Codex CLI deep-interview intake, then execute)
  omxc autoresearch [--topic T] [--evaluator CMD] [--keep-policy P] [--slug S]
  omxc autoresearch init [--topic T] [--evaluator CMD] [--keep-policy P] [--slug S]
  omxc autoresearch run <mission-dir> [codex-args...]              (agent/explicit execution entrypoint)
  omxc autoresearch <mission-dir> [codex-args...]                  (compatibility alias for run)
  omxc autoresearch --resume <run-id> [codex-args...]
...
function buildAutoresearchDeepInterviewAppendix(): string {
  return [
    ...
    'Do not start tmux, do not launch `omxc autoresearch`, and do not bypass the user confirmation boundary.',
