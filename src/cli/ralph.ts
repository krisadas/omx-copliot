...
export const RALPH_HELP = `omxc ralph - Launch Copilot CLI with ralph persistence mode active

Usage:
  omxc ralph [task text...]
  omxc ralph --prd "<task text>"
  omxc ralph [ralph-options] [codex-args...] [task text...]
...
Common patterns:
  omxc ralph "Fix flaky notify-hook tests"
  omxc ralph --prd "Ship release checklist automation"
  omxc ralph --model gpt-5 "Refactor state hydration"
  omxc ralph -- --task-with-leading-dash
`;
