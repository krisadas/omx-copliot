...
function buildAdditionalContextMessage(prompt: string, skillState?: SkillActiveState | null): string | null {
  ...
  if (match.skill === "team") {
    ...
    return [
      ...
      "Use the durable OMX team runtime via `omxc team ...` for coordinated execution; do not replace it with in-process fanout.",
      "If you need help, run `omxc team --help`.",
