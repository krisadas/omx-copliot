...
Το OMX είναι ένα workflow layer για το [GitHub Copilot CLI](https://github.com/openai/codex).
...
- Node.js 20+
- Εγκατεστημένο Copilot CLI: `npm install -g @openai/codex`
...
1. Εκτελέστε `omxc setup`
2. Εκκινήστε με `omxc --madmax --high`
...
- `omxc setup` εγκαθιστά prompts, skills, ρυθμίσεις και scaffolding AGENTS
- `omxc doctor` επαληθεύει την εγκατάσταση όταν κάτι φαίνεται λάθος
- `omxc hud --watch` είναι λειτουργία παρακολούθησης/κατάστασης, όχι η κύρια ροή εργασίας του χρήστη

### Explore και sparkshell

- `omxc explore --prompt "..."` είναι για αναζήτηση μόνο ανάγνωσης στο repository
- `omxc sparkshell <command>` είναι για επιθεώρηση απευθείας από το shell και στοχευμένη επαλήθευση
...
Η `omxc team` χρειάζεται ένα tmux-συμβατό backend:
