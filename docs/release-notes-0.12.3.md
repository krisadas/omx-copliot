...
- `$team` detected in `UserPromptSubmit` now seeds root `team-state.json` and nudges operators toward `omxc team ...` / `omxc team --help` instead of silently misrouting the prompt (#1364)
