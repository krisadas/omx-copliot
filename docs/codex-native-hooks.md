...
`omxc setup` now owns both of these native Codex artifacts:
...
- **tmux/runtime fallbacks**: `omxc tmux-hook`, notify-hook, derived watcher, idle/session-end reporters
...
1. **Native Codex hook proof**
   - `omxc setup` wrote `.codex/hooks.json`
